...
$l['thx_config_alerts_none'] = "Thank you mybb plugin it's already to be used, you need (<a href=\"{1}\"> Download MyAlerts 2.0 or better </a>)";
$l['thx_config_alerts_missing'] = "You mus disable and enable this plugin again to load MyAlerts formatter in this way you got an error, save you styles all info will be reloaded, like stylesheet, templates and settings for this plugin...";
